export default `
  ...
  .ant-menu-dark .ant-menu-submenu-open .ant-menu-item-selected > a{
    color: #fff;
  }
  ...
  .ant-calendar-range .ant-calendar-selected-start-date .ant-picker-cell-inner,
  .ant-calendar-range .ant-calendar-selected-end-date .ant-picker-cell-inner {
    background: var(--primary-color);
  }
  .ant-calendar-range .ant-calendar-selected-start-date .ant-picker-cell-inner:hover,
  .ant-calendar-range .ant-calendar-selected-end-date .ant-picker-cell-inner:hover {
    background: var(--primary-hover-color);
  }
